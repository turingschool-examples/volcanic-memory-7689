...
ActiveRecord::Schema[7.0].define(version: 2024_01_16_161250) do
  ...
  create_table "experiments_scientists", id: false, force: :cascade do |t|
    ...
    t.index ["experiment_id"], name: "index_experiments_scientists_on_experiment_id"
    t.index ["scientist_id"], name: "index_experiments_scientists_on_scientist_id"
  end
